...
import com.focus.Pages.ModifiedScriptForDelete;
import com.focus.base.BaseEngine;

public class ModifiedScriptForDeleteTest extends BaseEngine {
	
	
	ModifiedScriptForDelete BNT;
	/*
	@Test(priority = 44301)
	public void checkDeleteCompanyOptionInSearch()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		BNT = new ModifiedScriptForDelete(getDriver());
	...
	*/ 
	...
	@Test(priority = 600048) // Error Message
	...
	@Test(priority = 600071) // in Links Suspended Col showing Empty and only to 1 voucher is dipslay
